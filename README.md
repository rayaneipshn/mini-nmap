...
## ✨ Fonctionnalités
- ⚡ **Multi-threading** : Utilisation de `threading` et `queue.Queue` pour scanner 100 ports en simultané sans blocage.
- 🎯 **Précision** : Analyse des connexions TCP via la bibliothèque native `socket`.
- ⏱️ **Mesure du temps** : Calcul précis de la durée de l'analyse.

## 🛠️ Installation & Utilisation

1. Clonez le dépôt :
   ```bash
   git clone https://github.com/rayaneipshn/mini-nmap.git
   cd mini-nmap
